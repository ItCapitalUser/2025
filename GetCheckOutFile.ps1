...
$ListName = "Garage" #!!!
$CSVPath = "C:\Temp\DLCOut-1.csv"
$BatchSize = 500

$SiteURL= "https://smartholdingcom-my.sharepoint.com/personal/e_knysh_veres_com_ua"
$ListName = "Архивная библиотека" #!!!
$CSVPath = "C:\Temp\DocumentLibrary-e_knysh_veres_com_ua-201124.csv"
$BatchSize = 500
...
Try {
    ...
    Do
    {
        ...
        ForEach($ListItem in $ListItems)
        {
            ...
            if($ListItem.FieldValues.CheckoutUser.LookupValue -ne $null)
            {
            ...
            $Data = New-Object PSObject -Property ([Ordered] @{
                ...
                Checkout = $ListItem.FieldValues.CheckoutUser.LookupValue
            })
            $DataCollection += $Data
            }
            Write-Host "----"
